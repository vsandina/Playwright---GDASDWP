...
test.describe.serial("SuggestedAssignment", () =>
{// Describe the test suite for SuggestedAssignment
    ...
    test("TC025_SuggestedAssignment", async () => {
        // Login
    ...
    test("TC025_EditActualHoursNextweek", async () => {
            ...
            await page.locator(".dicon-preparer-nc").click();
            await page.locator("//button[normalize-space()='Suggest Assignment']").click();
            await ReportUtils.screenshot(page, "SuggestedAssignment");
